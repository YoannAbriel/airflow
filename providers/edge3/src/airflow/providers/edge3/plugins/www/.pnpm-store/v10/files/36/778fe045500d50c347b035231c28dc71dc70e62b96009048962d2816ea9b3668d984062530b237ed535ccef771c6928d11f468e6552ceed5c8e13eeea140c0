...
import { EOL } from 'os';
import cp from '@apidevtools/json-schema-ref-parser';
import f from 'handlebars';

const require = createRequire(import.meta.url);
var yi=Object.create;var Cn=Object.defineProperty;var gi=Object.getOwnPropertyDescriptor;var hi=Object.getOwnPropertyNames;var xi=Object.getPrototypeOf,Oi=Object.prototype.hasOwnProperty;var Z=(e=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(e,{get:(t,r)=>(typeof require<"u"?require:t)[r]}):e)(function(e){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+e+'" is not supported')});var U=(e,t)=>()=>(t||e((t={exports:{}}).exports,t),t.exports);var bi=(e,t,r,s)=>{if(t&&typeof t=="object"||typeof t=="function")for(let n of hi(t))!Oi.call(e,n)&&n!==r&&Cn(e,n,{get:()=>t[n],enumerable:!(s=gi(t,n))||s.enumerable});return e};var Pi=(e,t,r)=>(r=e!=null?yi(xi(e)):{},bi(Cn(r,"default",{value:e,enumerable:!0}),e));var En=U(($p,vn)=>{vn.exports=An;An.sync=Ti;var Tn=Z("fs");function Ci(e,t){var r=t.pathExt!==void 0?t.pathExt:process.env.PATHEXT;if(!r||(r=r.split(";"),r.indexOf("")!==-1))return !0;for(var s=0;s<r.length;s++){var n=r[s].toLowerCase();if(n&&e.substr(-n.length).toLowerCase()===n)return !0}return !1}function Rn(e,t,r){return !e.isSymbolicLink()&&!e.isFile()?!1:Ci(t,r)}function An(e,t,r){Tn.stat(e,function(s,n){r(s,s?!1:Rn(n,e,t));});}function Ti(e,t){return Rn(Tn.statSync(e),e,t)}});var wn=U((Ip,Nn)=>{Nn.exports=Sn;Sn.sync=Ri;var qn=Z("fs");function Sn(e,t,r){qn.stat(e,function(s,n){r(s,s?!1:kn(n,t));});}function Ri(e,t){return kn(qn.statSync(e),t)}function kn(e,t){return e.isFile()&&Ai(e,t)}function Ai(e,t){var r=e.mode,s=e.uid,n=e.gid,o=t.uid!==void 0?t.uid:process.getuid&&process.getuid(),a=t.gid!==void 0?t.gid:process.getgid&&process.getgid(),i=parseInt("100",8),p=parseInt("010",8),c=parseInt("001",8),m=i|p,u=r&c||r&p&&n===a||r&i&&s===o||r&m&&o===0;return u}});var In=U((Mp,$n)=>{Z("fs");var rt;process.platform==="win32"||global.TESTING_WINDOWS?rt=En():rt=wn();$n.exports=Ut;Ut.sync=vi;function Ut(e,t,r){if(typeof t=="function"&&(r=t,t={}),!r){if(typeof Promise!="function")throw new TypeError("callback not provided");return new Promise(function(s,n){Ut(e,t||{},function(o,a){o?n(o):s(a);});})}rt(e,t||{},function(s,n){s&&(s.code==="EACCES"||t&&t.ignoreErrors)&&(s=null,n=!1),r(s,n);});}function vi(e,t){try{return rt.sync(e,t||{})}catch(r){if(t&&t.ignoreErrors||r.code==="EACCES")return !1;throw r}}});var Ln=U((jp,Bn)=>{var Ne=process.platform==="win32"||process.env.OSTYPE==="cygwin"||process.env.OSTYPE==="msys",Dn=Z("path"),Ei=Ne?";":":",Mn=In(),jn=e=>Object.assign(new Error(`not found: ${e}`),{code:"ENOENT"}),Hn=(e,t)=>{let r=t.colon||Ei,s=e.match(/\//)||Ne&&e.match(/\\/)?[""]:[...Ne?[process.cwd()]:[],...(t.path||process.env.PATH||"").split(r)],n=Ne?t.pathExt||process.env.PATHEXT||".EXE;.CMD;.BAT;.COM":"",o=Ne?n.split(r):[""];return Ne&&e.indexOf(".")!==-1&&o[0]!==""&&o.unshift(""),{pathEnv:s,pathExt:o,pathExtExe:n}},Fn=(e,t,r)=>{typeof t=="function"&&(r=t,t={}),t||(t={});let{pathEnv:s,pathExt:n,pathExtExe:o}=Hn(e,t),a=[],i=c=>new Promise((m,u)=>{if(c===s.length)return t.all&&a.length?m(a):u(jn(e));let d=s[c],h=/^".*"$/.test(d)?d.slice(1,-1):d,O=Dn.join(h,e),x=!h&&/^\.[\\\/]/.test(e)?e.slice(0,2)+O:O;m(p(x,c,0));}),p=(c,m,u)=>new Promise((d,h)=>{if(u===n.length)return d(i(m+1));let O=n[u];Mn(c+O,{pathExt:o},(x,E)=>{if(!x&&E)if(t.all)a.push(c+O);else return d(c+O);return d(p(c,m,u+1))});});return r?i(0).then(c=>r(null,c),r):i(0)},qi=(e,t)=>{t=t||{};let{pathEnv:r,pathExt:s,pathExtExe:n}=Hn(e,t),o=[];for(let a=0;a<r.length;a++){let i=r[a],p=/^".*"$/.test(i)?i.slice(1,-1):i,c=Dn.join(p,e),m=!p&&/^\.[\\\/]/.test(e)?e.slice(0,2)+c:c;for(let u=0;u<s.length;u++){let d=m+s[u];try{if(Mn.sync(d,{pathExt:n}))if(t.all)o.push(d);else return d}catch{}}}if(t.all&&o.length)return o;if(t.nothrow)return null;throw jn(e)};Bn.exports=Fn;Fn.sync=qi;});var Un=U((Hp,Vt)=>{var _n=(e={})=>{let t=e.env||process.env;return (e.platform||process.platform)!=="win32"?"PATH":Object.keys(t).reverse().find(s=>s.toUpperCase()==="PATH")||"Path"};Vt.exports=_n;Vt.exports.default=_n;});var Wn=U((Fp,Qn)=>{var Vn=Z("path"),Si=Ln(),ki=Un();function Kn(e,t){let r=e.options.env||process.env,s=process.cwd(),n=e.options.cwd!=null,o=n&&process.chdir!==void 0&&!process.chdir.disabled;if(o)try{process.chdir(e.options.cwd);}catch{}let a;try{a=Si.sync(e.command,{path:r[ki({env:r})],pathExt:t?Vn.delimiter:void 0});}catch{}finally{o&&process.chdir(s);}return a&&(a=Vn.resolve(n?e.options.cwd:"",a)),a}function Ni(e){return Kn(e)||Kn(e,!0)}Qn.exports=Ni;});var Gn=U((Bp,Qt)=>{var Kt=/([()\][%!^"`<>&|;, *?])/g;function wi(e){return e=e.replace(Kt,"^$1"),e}function $i(e,t){return e=`${e}`,e=e.replace(/(\\*)"/g,'$1$1\\"'),e=e.replace(/(\\*)$/,"$1$1"),e=`"${e}"`,e=e.replace(Kt,"^$1"),t&&(e=e.replace(Kt,"^$1")),e}Qt.exports.command=wi;Qt.exports.argument=$i;});var zn=U((Lp,Xn)=>{Xn.exports=/^#!(.*)/;});var Yn=U((_p,Jn)=>{var Ii=zn();Jn.exports=(e="")=>{let t=e.match(Ii);if(!t)return null;let[r,s]=t[0].replace(/#! ?/,"").split(" "),n=r.split("/").pop();return n==="env"?s:s?`${n} ${s}`:n};});var er=U((Up,Zn)=>{var Wt=Z("fs"),Di=Yn();function Mi(e){let r=Buffer.alloc(150),s;try{s=Wt.openSync(e,"r"),Wt.readSync(s,r,0,150,0),Wt.closeSync(s);}catch{}return Di(r.toString())}Zn.exports=Mi;});var or=U((Vp,rr)=>{var ji=Z("path"),tr=Wn(),nr=Gn(),Hi=er(),Fi=process.platform==="win32",Bi=/\.(?:com|exe)$/i,Li=/node_modules[\\/].bin[\\/][^\\/]+\.cmd$/i;function _i(e){e.file=tr(e);let t=e.file&&Hi(e.file);return t?(e.args.unshift(e.file),e.command=t,tr(e)):e.file}function Ui(e){if(!Fi)return e;let t=_i(e),r=!Bi.test(t);if(e.options.forceShell||r){let s=Li.test(t);e.command=ji.normalize(e.command),e.command=nr.command(e.command),e.args=e.args.map(o=>nr.argument(o,s));let n=[e.command].concat(e.args).join(" ");e.args=["/d","/s","/c",`"${n}"`],e.command=process.env.comspec||"cmd.exe",e.options.windowsVerbatimArguments=!0;}return e}function Vi(e,t,r){t&&!Array.isArray(t)&&(r=t,t=null),t=t?t.slice(0):[],r=Object.assign({},r);let s={command:e,args:t,options:r,file:void 0,original:{command:e,args:t}};return r.shell?s:Ui(s)}rr.exports=Vi;});var ar=U((Kp,ir)=>{var Gt=process.platform==="win32";function Xt(e,t){return Object.assign(new Error(`${t} ${e.command} ENOENT`),{code:"ENOENT",errno:"ENOENT",syscall:`${t} ${e.command}`,path:e.command,spawnargs:e.args})}function Ki(e,t){if(!Gt)return;let r=e.emit;e.emit=function(s,n){if(s==="exit"){let o=sr(n,t);if(o)return r.call(e,"error",o)}return r.apply(e,arguments)};}function sr(e,t){return Gt&&e===1&&!t.file?Xt(t.original,"spawn"):null}function Qi(e,t){return Gt&&e===1&&!t.file?Xt(t.original,"spawnSync"):null}ir.exports={hookChildProcess:Ki,verifyENOENT:sr,verifyENOENTSync:Qi,notFoundError:Xt};});var mr=U((Qp,we)=>{var pr=Z("child_process"),zt=or(),Jt=ar();function cr(e,t,r){let s=zt(e,t,r),n=pr.spawn(s.command,s.args,s.options);return Jt.hookChildProcess(n,s),n}function Wi(e,t,r){let s=zt(e,t,r),n=pr.spawnSync(s.command,s.args,s.options);return n.error=n.error||Jt.verifyENOENTSync(n.status,s),n}we.exports=cr;we.exports.spawn=cr;we.exports.sync=Wi;we.exports._parse=zt;we.exports._enoent=Jt;});var bn=Pi(mr());var lr,g=()=>lr,ur=e=>(lr=e,g()),R=e=>("client"in e?e.client.name:e.name).startsWith("legacy/");var ot=e=>{switch(e.name){case"legacy/angular":return "AngularHttpRequest";case"legacy/axios":return "AxiosHttpRequest";case"legacy/fetch":return "FetchHttpRequest";case"legacy/node":return "NodeHttpRequest";case"legacy/xhr":return "XHRHttpRequest";default:return ""}};function $e(e,t){let r=e.toLocaleLowerCase(),s=t.toLocaleLowerCase();return r.localeCompare(s,"en")}var Ge=(e,t)=>$e(e.name,t.name);function Xe(e){return e.sort(Ge)}var Ie=e=>{existsSync(e)||mkdirSync(e,{recursive:!0});},ze=({moduleOutput:e,sourceOutput:t})=>{let r=t.split("/");return `${new Array(r.length).fill("").join("../")||"./"}${e}`};var fr=async(e,t,r,s)=>{let n=g(),o=s.client({$config:n,...r,httpRequest:ot(n.client),models:Xe(r.models),services:Xe(r.services)});n.name&&(Ie(t),writeFileSync(K.resolve(t,`${n.name}.ts`),o));};var Ce=({sourceOutput:e})=>{let t=g();return t.client.bundle?ze({moduleOutput:"client",sourceOutput:e}):t.client.name},Te=()=>"Options",dr=async(e,t)=>{let r=g();if(R(r)||!r.client.bundle)return;let s=K.resolve(e,"client");Ie(s);let o=K.normalize(Z.resolve(t)).split(K.sep),a=[...o.slice(0,o.indexOf("dist")),"src"].join(K.sep);["index.ts","types.ts","utils.ts"].forEach(p=>{copyFileSync(K.resolve(a,p),K.resolve(s,p));});};var yr=async(e,t,r)=>{let s=g();if(s.exportCore){let n={httpRequest:ot(s.client),server:s.base!==void 0?s.base:t.server,version:t.version};if(rmSync(K.resolve(e),{force:!0,recursive:!0}),mkdirSync(K.resolve(e),{recursive:!0}),await writeFileSync(K.resolve(e,"OpenAPI.ts"),r.core.settings({$config:s,...n})),await writeFileSync(K.resolve(e,"ApiError.ts"),r.core.apiError({$config:s,...n})),await writeFileSync(K.resolve(e,"ApiRequestOptions.ts"),r.core.apiRequestOptions({$config:s,...n})),await writeFileSync(K.resolve(e,"ApiResult.ts"),r.core.apiResult({$config:s,...n})),s.client.name!=="legacy/angular"&&await writeFileSync(K.resolve(e,"CancelablePromise.ts"),r.core.cancelablePromise({$config:s,...n})),await writeFileSync(K.resolve(e,"request.ts"),r.core.request({$config:s,...n})),s.name&&(await writeFileSync(K.resolve(e,"BaseHttpRequest.ts"),r.core.baseHttpRequest({$config:s,...n})),await writeFileSync(K.resolve(e,`${n.httpRequest}.ts`),r.core.httpRequest({$config:s,...n}))),s.request){let o=K.resolve(process.cwd(),s.request);if(!await existsSync(o))throw new Error(`Custom request file "${o}" does not exists`);await copyFileSync(o,K.resolve(e,"request.ts"));}}};var st=/^[^$_\p{ID_Start}]+/u,ee=/^(arguments|break|case|catch|class|const|continue|debugger|default|delete|do|else|enum|eval|export|extends|false|finally|for|function|if|implements|import|in|instanceof|interface|let|new|null|package|private|protected|public|return|static|super|switch|this|throw|true|try|typeof|var|void|while|with|yield)$/g,ce=/^[$_\p{ID_Start}][$\u200c\u200d\p{ID_Continue}]*$/u;var te=e=>(e||e==="")&&(ce.lastIndex=0,!ce.test(e))?`'${e}'`:e,Me=e=>e&&e.startsWith("'")&&e.endsWith("'")?e.slice(1,e.length-1):e,w=e=>e.replace(/\*\//g,"*").replace(/\/\*/g,"*").replace(/\r?\n(.*)/g,(t,r)=>EOL+r.trim());var it={newLine:y.NewLineKind.LineFeed,scriptKind:y.ScriptKind.TS,scriptTarget:y.ScriptTarget.ES2015,useSingleQuotes:!0},oa=y.createPrinter({newLine:it.newLine}),gr=e=>y.createSourceFile("",e,it.scriptTarget,void 0,it.scriptKind),sa=gr(""),ia=e=>e.replace(/\\u([0-9a-fA-F]{4})/g,(t,r)=>String.fromCharCode(Number.parseInt(r,16)));function Re({node:e,unescape:t=!1}){let r=oa.printNode(y.EmitHint.Unspecified,e,sa);if(!t)return r;try{return ia(r)}catch{return g().debug&&console.warn("Could not decode value:",r),r}}function hr(e){return gr(e).statements[0]}var b=({text:e})=>y.factory.createIdentifier(e),V={boolean:e=>e?y.factory.createTrue():y.factory.createFalse(),export:({alias:e,asType:t=!1,name:r})=>{let s=b({text:r});if(e){let n=b({text:e});return y.factory.createExportSpecifier(t,s,n)}return y.factory.createExportSpecifier(t,void 0,s)},import:({alias:e,asType:t=!1,name:r})=>{let s=b({text:r});if(e){let n=b({text:e});return y.factory.createImportSpecifier(t,s,n)}return y.factory.createImportSpecifier(t,void 0,s)},number:e=>e<0?y.factory.createPrefixUnaryExpression(y.SyntaxKind.MinusToken,y.factory.createNumericLiteral(Math.abs(e))):y.factory.createNumericLiteral(e),string:(e,t=!1)=>{let r=e;t&&(r=Me(r));let s=r.includes("'")&&r.includes('"'),n=r.includes(`
`),o=r.startsWith("`"),a=r.startsWith("\\`")&&r.endsWith("\\`");return (n||s||o)&&!a&&(r=`\`${r.replace(/(?<!\\)`/g,"\\`").replace(/\${/g,"\\${")}\``),r.startsWith("`")?b({text:r}):y.factory.createStringLiteral(r,r.includes("'")?!1:it.useSingleQuotes)}},Ae=e=>e!==null&&typeof e=="object"&&typeof e.kind=="number"&&typeof e.flags=="number"&&typeof e.pos=="number"&&typeof e.end=="number",de=e=>e!==void 0,aa=({commentObject:e,node:t})=>{let r=e.lines.filter(a=>!!a||a==="");if(!r.length)return;if(!e.jsdoc){for(let a of r)y.addSyntheticLeadingComment(t,y.SyntaxKind.SingleLineCommentTrivia,` ${a}`,!0);return}let s=r.map((a,i)=>{let p=a;return i!==r.length&&(p=`${p}
`),y.factory.createJSDocText(p)}),n=y.factory.createJSDocComment(y.factory.createNodeArray(s),void 0),o=Re({node:n,unescape:!0}).replace("/*","").replace("*  */","");y.addSyntheticLeadingComment(t,y.SyntaxKind.MultiLineCommentTrivia,o,!0);},M=({comments:e=[],node:t})=>{let r=!!e.find(n=>typeof n=="object"&&n),s=e;r||(s=[{jsdoc:!0,lines:e}]);for(let n of s)aa({commentObject:n,node:t});};var B=(e,t)=>y.isTypeNode(e)?e:typeof e=="number"?y.factory.createLiteralTypeNode(V.number(e)):X({typeArguments:t?.map(r=>B(r)),typeName:e}),Yt=({expression:e,name:t})=>y.factory.createPropertyAccessChain(e,y.factory.createToken(y.SyntaxKind.QuestionDotToken),t),ne=({expression:e,isOptional:t,name:r})=>{let s=typeof e=="string"?b({text:e}):e;if(t)return Yt({expression:s,name:r});let n=typeof r=="string"?b({text:r}):r;return typeof r=="string"&&(ce.lastIndex=0,!ce.test(r))?y.factory.createElementAccessExpression(s,n):y.factory.createPropertyAccessExpression(s,n)},ve=({identifiers:e=[],isValueAccess:t,shorthand:r,unescape:s,value:n})=>{if(n===null)return y.factory.createNull();if(Array.isArray(n))return Zt({elements:n});if(typeof n=="object")return mt({identifiers:e,obj:n,shorthand:r});if(typeof n=="number")return V.number(n);if(typeof n=="boolean")return V.boolean(n);if(typeof n=="string"){if(t){let o=n.split(".");return ne({expression:o[0],name:o[1]})}return V.string(n,s)}},at=e=>{let t=e==="public"?y.SyntaxKind.PublicKeyword:e==="protected"?y.SyntaxKind.ProtectedKeyword:e==="private"?y.SyntaxKind.PrivateKeyword:void 0,r=[];return t&&r.push(y.factory.createModifier(t)),r},Je=e=>e.map(t=>{if("destructure"in t)return y.factory.createParameterDeclaration(void 0,void 0,y.factory.createObjectBindingPattern(t.destructure.map(s=>"destructure"in s?void 0:y.factory.createBindingElement(void 0,void 0,b({text:s.name}),void 0)).filter(Boolean)),void 0,void 0,void 0);let r=at(t.accessLevel);return t.isReadOnly&&(r=[...r,y.factory.createModifier(y.SyntaxKind.ReadonlyKeyword)]),y.factory.createParameterDeclaration(r,void 0,b({text:t.name}),t.isRequired===!1?y.factory.createToken(y.SyntaxKind.QuestionToken):void 0,t.type!==void 0?B(t.type):void 0,t.default!==void 0?ve({value:t.default}):void 0)}),pt=({keyword:e})=>{let t=y.SyntaxKind.AnyKeyword;switch(e){case"boolean":t=y.SyntaxKind.BooleanKeyword;break;case"string":t=y.SyntaxKind.StringKeyword;break}return y.factory.createKeywordTypeNode(t)},Ye=e=>e.map(t=>y.factory.createTypeParameterDeclaration(void 0,t.name,t.extends?typeof t.extends=="string"?pt({keyword:"boolean"}):t.extends:void 0,t.default!==void 0?Ae(t.default)?t.default:y.factory.createLiteralTypeNode(t.default?y.factory.createTrue():y.factory.createFalse()):void 0)),ct=({async:e,comment:t,multiLine:r,parameters:s=[],returnType:n,statements:o=[],types:a=[]})=>{let i=y.factory.createArrowFunction(e?[y.factory.createModifier(y.SyntaxKind.AsyncKeyword)]:void 0,a?Ye(a):void 0,Je(s),n?B(n):void 0,void 0,Array.isArray(o)?y.factory.createBlock(o,r):o);return M({comments:t,node:i}),i},xr=({async:e,comment:t,multiLine:r,parameters:s=[],returnType:n,statements:o=[],types:a=[]})=>{let i=y.factory.createFunctionExpression(e?[y.factory.createModifier(y.SyntaxKind.AsyncKeyword)]:void 0,void 0,void 0,a?Ye(a):void 0,Je(s),n?B(n):void 0,y.factory.createBlock(o,r));return M({comments:t,node:i}),i},Zt=({elements:e,multiLine:t=!1})=>y.factory.createArrayLiteralExpression(e.map(s=>Ae(s)?s:ve({value:s})).filter(de),t||!Array.isArray(e[0])&&typeof e[0]=="object"),Or=({expression:e})=>y.factory.createAwaitExpression(e),mt=({comments:e,identifiers:t=[],multiLine:r=!0,obj:s,shorthand:n,unescape:o=!1})=>{let a=Array.isArray(s)?s.map(p=>{let c=!1;if("key"in p){let{key:u}=p;c=u===p.value,(u.match(/^[0-9]/)&&u.match(/\D+/g)||u.match(/\W/g))&&!u.startsWith("'")&&!u.endsWith("'")&&(p.key=`'${u}'`);}let m;if("spread"in p){let u=Ae(p.spread)?p.spread:b({text:p.spread});m=y.factory.createSpreadAssignment(p.assertion?y.factory.createAsExpression(u,pt({keyword:p.assertion})):u);}else if(p.shorthand||n&&c)m=y.factory.createShorthandPropertyAssignment(p.value);else {let u=Ae(p.value)?p.value:Array.isArray(p.value)?mt({multiLine:r,obj:p.value,shorthand:n,unescape:o}):ve({identifiers:t.includes(p.key)?Object.keys(p.value):[],isValueAccess:p.isValueAccess,shorthand:n,unescape:o,value:p.value});if(!u)return;t.includes(p.key)&&!y.isObjectLiteralExpression(u)&&(u=b({text:p.value})),m=y.factory.createPropertyAssignment(p.key,u);}return M({comments:p.comments,node:m}),m}).filter(de):Object.entries(s).map(([p,c])=>{let m=ve({identifiers:t.includes(p)?Object.keys(c):[],shorthand:n,unescape:o,value:c});if(!m)return;t.includes(p)&&!y.isObjectLiteralExpression(m)&&(m=b({text:c}));let u=p===c;return p.match(/^[0-9]/)&&p.match(/\D+/g)&&!p.startsWith("'")&&!p.endsWith("'")&&(p=`'${p}'`),p.match(/\W/g)&&!p.startsWith("'")&&!p.endsWith("'")&&(p=`'${p}'`),n&&u?y.factory.createShorthandPropertyAssignment(c):y.factory.createPropertyAssignment(p,m)}).filter(de),i=y.factory.createObjectLiteralExpression(a,r);return M({comments:e,node:i}),i},br=({comments:e,leadingComment:t,name:r,obj:s})=>{let n=y.factory.createEnumDeclaration([y.factory.createModifier(y.SyntaxKind.ExportKeyword)],b({text:r}),Object.entries(s).map(([o,a])=>{let i=ve({unescape:!0,value:a}),p=y.factory.createEnumMember(o,i),c=e?.[o];return M({comments:c,node:p}),p}));return M({comments:t,node:n}),n},Pr=({name:e,statements:t})=>y.factory.createModuleDeclaration([y.factory.createModifier(y.SyntaxKind.ExportKeyword)],b({text:e}),y.factory.createModuleBlock(t),y.NodeFlags.Namespace),Cr=({indexType:e,objectType:t})=>y.factory.createIndexedAccessTypeNode(t,e),Tr=({text:e})=>y.factory.createStringLiteral(e),Rr=({condition:e,whenFalse:t,whenTrue:r})=>y.factory.createConditionalExpression(e,y.factory.createToken(y.SyntaxKind.QuestionToken),r,y.factory.createToken(y.SyntaxKind.ColonToken),t),Ar=({text:e})=>y.factory.createTypeOfExpression(b({text:e})),vr=({comment:e,exportType:t,name:r,type:s,typeParameters:n=[]})=>{let o=y.factory.createTypeAliasDeclaration(t?[y.factory.createModifier(y.SyntaxKind.ExportKeyword)]:void 0,b({text:r}),Ye(n),B(s));return M({comments:e,node:o}),o},X=({typeArguments:e,typeName:t})=>y.factory.createTypeReferenceNode(t,e),Er=({type:e})=>y.factory.createParenthesizedType(e);var qr=({module:e})=>y.factory.createExportDeclaration(void 0,!1,void 0,V.string(e)),re=({parameters:e=[],functionName:t,types:r})=>{let s=typeof t=="string"?b({text:t}):t,n=e.filter(a=>a!==void 0).map(a=>typeof a=="string"?b({text:a}):a);return y.factory.createCallExpression(s,r,n)},Sr=({exports:e,module:t})=>{let r=Array.isArray(e)?e:[e],s=r.some(p=>typeof p!="object"||!p.asType),n=r.map(p=>{let c=typeof p=="string"?{name:p}:p;return V.export({alias:c.alias,asType:s&&c.asType,name:c.name})}),o=y.factory.createNamedExports(n),a=V.string(t);return y.factory.createExportDeclaration(void 0,!s,o,a)},kr=({comment:e,assertion:t,destructure:r,exportConst:s,expression:n,name:o,typeName:a})=>{let i=t?y.factory.createAsExpression(n,typeof t=="string"?X({typeName:t}):t):n,p=b({text:o}),c=y.factory.createVariableDeclaration(r?y.factory.createObjectBindingPattern([y.factory.createBindingElement(void 0,void 0,p,void 0)]):p,void 0,a?typeof a=="string"?X({typeName:a}):a:void 0,i),m=y.factory.createVariableStatement(s?[y.factory.createModifier(y.SyntaxKind.ExportKeyword)]:void 0,y.factory.createVariableDeclarationList([c],y.NodeFlags.Const));return M({comments:e,node:m}),m},Nr=({imports:e,module:t})=>{let r=Array.isArray(e)?e:[e],s=r.some(c=>typeof c!="object"||!c.asType),n=r.map(c=>{let m=typeof c=="string"?{name:c}:c;return V.import({alias:m.alias,asType:s&&m.asType,name:m.name})}),o=y.factory.createNamedImports(n),a=y.factory.createImportClause(!s,void 0,o),i=V.string(t);return y.factory.createImportDeclaration(void 0,a,i)};var wr=({accessLevel:e,comment:t,multiLine:r=!0,parameters:s=[],statements:n=[]})=>{let o=y.factory.createConstructorDeclaration(at(e),Je(s),y.factory.createBlock(n,r));return M({comments:t,node:o}),o},$r=({accessLevel:e,comment:t,isStatic:r=!1,multiLine:s=!0,name:n,parameters:o=[],returnType:a,statements:i=[],types:p=[]})=>{let c=at(e);r&&(c=[...c,y.factory.createModifier(y.SyntaxKind.StaticKeyword)]);let m=y.factory.createMethodDeclaration(c,void 0,b({text:n}),void 0,p?Ye(p):void 0,Je(o),a?B(a):void 0,y.factory.createBlock(i,s));return M({comments:t,node:m}),m},Ir=({decorator:e,members:t=[],name:r})=>{let s=[y.factory.createModifier(y.SyntaxKind.ExportKeyword)];e&&(s=[y.factory.createDecorator(re({functionName:e.name,parameters:e.args.map(o=>ve({value:o})).filter(de)})),...s]);let n=[];return t.forEach(o=>{n=[...n,o,b({text:`
`})];}),y.factory.createClassDeclaration(s,b({text:r}),[],[],n)};var Ee=({expression:e})=>y.factory.createExpressionStatement(e);var Mr=({expression:e})=>y.factory.createReturnStatement(e),jr=({args:e=[],name:t,types:r=[]})=>{let s=r.map(i=>X({typeName:i})),n=e.map(i=>y.isExpression(i)?i:b({text:i})).filter(de),o=re({functionName:t,parameters:n,types:s});return Mr({expression:o})},Hr=({expression:e})=>Mr({expression:typeof e=="string"?b({text:e}):e});var je=e=>e.slice(1).reduce((t,r)=>(ce.lastIndex=0,ce.test(r)?Yt({expression:t,name:r}):y.factory.createElementAccessChain(t,y.factory.createToken(y.SyntaxKind.QuestionDotToken),b({text:r}))),b({text:e[0]})),lt=e=>e.slice(1).reduce((t,r)=>ne({expression:t,name:r}),b({text:e[0]})),Fr=({expressions:e})=>e.reduce((r,s)=>ne({expression:r,name:s})),Br=({left:e,operator:t="=",right:r})=>y.factory.createBinaryExpression(e,t==="="?y.SyntaxKind.EqualsToken:t==="==="?y.SyntaxKind.EqualsEqualsEqualsToken:y.SyntaxKind.InKeyword,typeof r=="string"?b({text:r}):r),He=({expression:e,thenStatement:t,elseStatement:r})=>y.factory.createIfStatement(e,t,r),Lr=({path:e})=>{let t=je(e),r=lt(e),s=y.factory.createBlock([Ee({expression:y.factory.createBinaryExpression(r,y.SyntaxKind.EqualsToken,y.factory.createNewExpression(b({text:"Date"}),void 0,[r]))})]);return He({expression:t,thenStatement:s})},_r=({path:e,transformerName:t})=>{let r=je(e),s=lt(e),n=y.factory.createBlock([Ee({expression:re({functionName:t,parameters:[s]})})],!0);return [He({expression:r,thenStatement:n})]},Ur=({path:e,transformerName:t})=>{let r=je(e),s=lt(e);return He({expression:re({functionName:ne({expression:"Array",name:"isArray"}),parameters:[r]}),thenStatement:y.factory.createBlock([Ee({expression:y.factory.createCallChain(ne({expression:s,name:"forEach"}),void 0,void 0,[b({text:t})])})],!0)})},Vr=({parameterName:e})=>{let t=b({text:"Date"});return y.factory.createNewExpression(t,void 0,[b({text:e})])},Kr=({path:e,transformExpression:t})=>{let r=je(e),s=lt(e);return He({expression:re({functionName:ne({expression:"Array",name:"isArray"}),parameters:[r]}),thenStatement:y.factory.createBlock([Ee({expression:y.factory.createBinaryExpression(s,y.factory.createToken(y.SyntaxKind.EqualsToken),y.factory.createCallChain(ne({expression:s,name:"map"}),void 0,void 0,[ct({parameters:[{name:"item"}],statements:t})]))})],!0)})};var ga=X({typeName:"null"}),Fe=({isNullable:e,node:t})=>e?y.factory.createUnionTypeNode([t,ga]):t,en=({isNullable:e,properties:t})=>{let r=y.factory.createTypeLiteralNode(t.map(s=>{let n=s.isReadOnly?[y.factory.createModifier(y.SyntaxKind.ReadonlyKeyword)]:void 0,o=s.isRequired!==!1?void 0:y.factory.createToken(y.SyntaxKind.QuestionToken),a=B(s.type),i=y.factory.createPropertySignature(n,s.name,o,a);return M({comments:s.comment,node:i}),i}));return Fe({isNullable:e,node:r})},Ze=({isNullable:e,types:t})=>{let r=t.map(n=>B(n)),s=y.factory.createUnionTypeNode(r);return Fe({isNullable:e,node:s})},Qr=({isNullable:e,types:t})=>{let r=t.map(n=>B(n)),s=y.factory.createIntersectionTypeNode(r);return Fe({isNullable:e,node:s})},Wr=({isNullable:e=!1,types:t})=>{let r=t.map(n=>B(n)),s=y.factory.createTupleTypeNode(r);return Fe({isNullable:e,node:s})},Gr=(e,t,r=!1)=>{let s=Ze({types:e}),n=Ze({types:t}),o=en({properties:[{name:`[key: ${Re({node:s,unescape:!0})}]`,type:n}]});return Fe({isNullable:r,node:o})},Xr=(e,t=!1)=>{let r=X({typeArguments:[Ze({types:e})],typeName:"Array"});return Fe({isNullable:t,node:r})};var zr=e=>{let t=e.match(/\.[0-9a-z]+$/i),r=t?t[0].slice(1):"",s=e.slice(0,e.length-(r?r.length+1:0));return {extension:r,name:s}},Q=class{_headers=[];_imports=new Map;_items=[];_name;_path;constructor({dir:t,name:r,header:s=!0}){this._name=this._setName(r),this._path=K.resolve(t,this.getName()),s&&(this._headers=[...this._headers,"// This file is auto-generated by @hey-api/openapi-ts"]);}add(...t){this._items=[...this._items,...t];}import({module:t,...r}){let s=this._imports.get(t);s||(s=new Map,this._imports.set(t,s));let n=s.get(r.name);return n||(s.set(r.name,r),r)}getName(t=!0){if(t)return this._name;let{name:r}=zr(this._name);return r}isEmpty(){return !this._items.length}remove(t){rmSync(this._path,t);}removeNode(){this._items=this._items.slice(0,this._items.length-1);}_setName(t){if(t.includes("index"))return t;let{extension:r,name:s}=zr(t);return [s,"gen",r].filter(Boolean).join(".")}toString(t=`
